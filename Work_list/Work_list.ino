...
String as="qwer";
  ...
  //
    ...
    myOLED.print( "Обновление экрана: 1 сек"    ,      0, 0);    // Выводим текст начиная с 0 столбца 0 строки.
    myOLED.print( " 1 сек"    ,      3, 1);    // Выводим текст начиная с 0 столбца 0 строки.
    myOLED.print( "Запись на SD: каждые 60 сек", OLED_C, 3);    // Выводим текст по центру 2 строки.
...
newString=DataTime+" "+HumTem+" "+Temper;
 ...
 Serial.println("Couldn't open log file");
  ...
  //
    ...
    //myOLED.print(i   , OLED_C, 3);    // Выводим текст по центру 3 строки.
    myOLED.print( "Tem:  "+Tem     , 0, 4);
    myOLED.print( "IR_s: "+ Temper , 0, 5);    // Выводим текст по центру 4 строки.
    //myOLED.print( "Запись в "  , 0, 6);    // Выводим текст по центру 6 строки.
    //myOLED.print( RedData+" "+RedTime  , 5, 7);    // Выводим текст по центру 7 строки.
